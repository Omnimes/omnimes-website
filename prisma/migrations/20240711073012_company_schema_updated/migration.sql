...
CREATE TABLE "role_requests" (
    ...
    CONSTRAINT "role_requests_pkey" PRIMARY KEY ("userId")
);
...
-- AddForeignKey
ALTER TABLE "users" ADD CONSTRAINT "users_adminCompanyId_fkey" FOREIGN KEY ("adminCompanyId") REFERENCES "companies"("id") ON DELETE SET NULL ON UPDATE CASCADE;
