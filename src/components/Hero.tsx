...
export const Hero = () => {
  ...
  // Postery
  const pathPoster = theme === "dark"
    ? "/images/poster/poster.dark.pl.png"
    : "/images/poster/poster.pl.png"
  const pathPosterOther = theme === "dark"
    ? "/images/poster/poster.dark.en.png"
    : "/images/poster/poster.en.png"
    ...
    <div className="relative mx-auto mt-12 max-w-7xl px-6 sm:mt-20 sm:px-8">
      <section className="grid grid-cols-1 items-center gap-12 sm:grid-cols-3">
        ...
        <div className="sm:col-span-2">
          ...
          <div className="relative isolate z-30 overflow-hidden rounded-xl bg-white dark:bg-content1 shadow-xl">
            ...
            <div className="aspect-[16/9] w-full">
              <Suspense fallback={<Skeleton className="h-full w-full rounded-xl" />}>
                <ReactPlayer
                  ...
                  className="react-player-fix h-full w-full"
                  url={path}
                  controls
                  width="100%"
                  height="100%"
                  ...
                  playIcon={
                    <button
                      ...
                      title={t("playAria")}
                      className="absolute left-1/2 top-1/2 z-40 flex h-20 w-20 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full bg-gradient-to-tr from-[#FF1CF7] to-[#b249f8] shadow-lg"
                    >
                      <VideoPlayIcon />
                    </button>
                  }
