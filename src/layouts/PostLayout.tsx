  ...
  return (
    <div className="w-full">
      ...
      <div className="relative">
        ...
        {!coverImage && (
          <div
            className="xs:py-14 relative bg-gradient-to-br from-blue-900 via-purple-900 
                          to-indigo-900 py-12 sm:py-16 md:py-20 lg:py-24"
          >
      ...
      <article className="xs:px-4 mx-auto max-w-5xl px-3 sm:px-4 lg:px-6">
        ...
        >
          {/* Share Section */}
          <div
            className="xs:p-4 border-b border-gray-100 bg-gradient-to-r from-blue-50 
                          to-purple-50 p-3 sm:p-6 
