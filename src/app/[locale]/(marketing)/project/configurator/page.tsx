...
export default async function ConfiguratorPage({
  ...
  return (
    <main>
      ...
      />
      <Image
        src={`/images/project/${localPath}/configuration/tree.png`}
        alt={t("altTree")}
        width={1650}
        height={656}
      ...
      />
      <Image
        src={`/images/project/${localPath}/configuration/light.png`}
        alt={t("altLight1")}
        width={1650}
        height={656}
      ...
      />
      <Image
        src={`/images/project/${localPath}/configuration/dark.png`}
        alt={t("altDark1")}
        width={1650}
        height={656}
      ...
      <Image
        src={`/images/project/${localPath}/configuration/2light.png`}
        alt={t("altLight2")}
        width={1650}
        height={656}
        className="mb-10 h-auto w-full rounded-md object-contain shadow-md dark:hidden"
      />
      <Image
        src={`/images/project/${localPath}/configuration/2dark.png`}
        alt={t("altDark2")}
        width={1650}
        height={656}
        className="mb-10 hidden h-auto w-full rounded-md object-contain shadow-md dark:flex"
