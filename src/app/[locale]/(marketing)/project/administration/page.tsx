...
export default async function AdministrationPage({
  ...
  const t = await getTranslations("AdministrationPage")
  ...
  return (
    <main>
      ...
      <Image
        src={`/images/project/${localPath}/administration/light.png`}
        alt={t("altLight")}
        width={1650}
        height={656}
      ...
      />
      <Image
        src={`/images/project/${localPath}/administration/dark.png`}
        alt={t("altDark")}
        width={1650}
        height={656}
