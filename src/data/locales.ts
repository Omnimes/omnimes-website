const primaryDialects: PrimaryDialects = {
  af: "af-ZA",
  ar: "ar",
  bg: "bg-BG",
  ca: "ca-AD",
...
// export const getLocalePrimaryDialects = <T extends keyof typeof primaryDialects>(locale: T) => {
//   return primaryDialects[locale] || primaryDialects['en'] as typeof primaryDialects[T];
// }

interface PrimaryDialects {
  [key: string]: string;
}

export const getLocalePrimaryDialects = (locale: string) => {
    return primaryDialects[locale] || primaryDialects['pl'];
}